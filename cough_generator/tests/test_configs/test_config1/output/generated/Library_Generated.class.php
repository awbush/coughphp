...
abstract class Library_Generated extends CoughObject {
	...
	public static function getDb() {
		if (is_null(Library::$db)) {
			Library::$db = CoughDatabaseFactory::getDatabase('test_cough_object');
		}
		return Library::$db;
	}
	
	public static function getDbName() {
		return Library::$dbName;
	}
	...
	public function loadBook2library_Collection() {
		...
		if ($this->hasKeyId()) {
			...
			$sql = '
				...
				WHERE
					`book2library`.`library_id` = ' . $db->quote($this->getLibraryId()) . '
			';
